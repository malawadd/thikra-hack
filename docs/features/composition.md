...
`services/api/app/repo/composer.py` — guarded at < 1300 formatted lines after adding editor media preparation, audible-mix extraction, multi-track rendering, and shared media/text layer transforms.
