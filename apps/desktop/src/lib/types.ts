...
export interface SequenceDocument { schema_version:1; preset:SequencePreset; background:string; tracks:SequenceTrack[]; clips:SequenceClip[]; duck_music_under_narration:boolean; captions_stale:boolean; }
