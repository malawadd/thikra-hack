...
{#snippet actions()}<a class="btn btn-primary" href="/payments/prava-test">Open Prava $0 test</a>{/snippet}
<PageHeader eyebrow="Commercial ledger" title="Payments" description="Authorization, credential readiness, provider purchase, delivery, acceptance, and redress are represented separately. Raw card data and one-time credentials never appear here." {actions} />
